...
export type BillingConfigItem = BillingConfigOneTimePlan | BillingConfigSubscriptionPlan | BillingConfigUsagePlan;
...
export type RequestResponseData = RecurringPaymentResponse['data']['appSubscriptionCreate'] | SinglePaymentResponse['data']['appPurchaseOneTimeCreate'];
